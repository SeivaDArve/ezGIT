...
# VARIABLES: They were loaded in another file. THIS comment line replaces them.
   # Their names were: $v_choosen_repo $v_nickname $v_choosen_file
...
if [ -z "$*" ]; then
   ...
   clear
   figlet ezGIT-syncER || echo -e "ezGIT-syncER \n" 
   ...
   echo "ezGIT-syncER: uDev: Description"
fi
